...
public class TransactionController {
    ...
    public ResponseEntity<CommonResponse<TransactionVO>> createTransaction(@Validated @RequestBody TransactionRequest request) {
    ...
    public ResponseEntity<CommonResponse> deleteTransaction(@RequestParam(name = "transactionId", required = true) String transactionId) {
    ...
    public ResponseEntity<CommonResponse<TransactionVO>> getTransaction(@RequestParam(name = "transactionId", required = true) String transactionId) {
